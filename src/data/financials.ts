export interface PeriodData {
  ...
  ai: number;
  affiliate: number;
  burnMultiple?: number; // EBITDA / net new revenue
}

export const MONTHS: PeriodData[] = [
  { label: 'Jan 2026', gtv: 248, revenue: 14.9, grossProfit: 5.9,  badDebt: 2.0, sm: 2.5, rd: 2.3, ga: 1.1, operatingIncome: -2.2, otherIncome:  0.3, ebitda: -1.9, netIncome: -1.9, cashBalance:  23.3, payins: 14.0, payouts: 0.7, platformFees: 0.2, ads: 0.1, wallet: 0.0, ai: 0.0, affiliate: 0.0, burnMultiple:  0.74 },
  { label: 'Feb 2026', gtv: 254, revenue: 14.1, grossProfit: 5.4,  badDebt: 1.7, sm: 3.0, rd: 2.0, ga: 1.7, operatingIncome: -3.0, otherIncome:  0.0, ebitda: -3.0, netIncome: -3.0, cashBalance: 121.7, payins: 13.2, payouts: 0.7, platformFees: 0.1, ads: 0.0, wallet: 0.0, ai: 0.0, affiliate: 0.0, burnMultiple: -3.50 },
  { label: 'Mar 2026', gtv: 308, revenue: 16.8, grossProfit: 6.0,  badDebt: 2.1, sm: 3.6, rd: 3.0, ga: 2.7, operatingIncome: -5.3, otherIncome:  0.5, ebitda: -4.8, netIncome: -4.8, cashBalance: 121.2, payins: 15.9, payouts: 0.8, platformFees: 0.1, ads: 0.0, wallet: 0.0, ai: 0.0, affiliate: 0.0, burnMultiple:  1.74 },
  { label: 'Apr 2026', gtv: 336, revenue: 18.0, grossProfit: 6.9,  badDebt: 2.8, sm: 3.3, rd: 2.7, ga: 2.3, operatingIncome: -4.4, otherIncome:  0.3, ebitda: -4.3, netIncome: -4.1, cashBalance: 114.8, payins: 16.9, payouts: 0.8, platformFees: 0.1, ads: 0.0, wallet: 0.0, ai: 0.0, affiliate: 0.1, burnMultiple:  3.50 },
  { label: 'May 2026', gtv: 353, revenue: 19.1, grossProfit: 7.8,  badDebt: 2.4, sm: 4.0, rd: 2.9, ga: 2.7, operatingIncome: -4.3, otherIncome:  0.6, ebitda: -4.0, netIncome: -3.7, cashBalance: 113.7, payins: 17.9, payouts: 0.9, platformFees: 0.1, ads: 0.1, wallet: 0.1, ai: 0.0, affiliate: 0.1, burnMultiple:  3.63 },
  { label: 'Jun 2026', gtv: 429, revenue: 22.9, grossProfit: 8.6,  badDebt: 3.2, sm: 3.7, rd: 3.1, ga: 2.5, operatingIncome: -4.0, otherIncome:  0.0, ebitda: -4.0, netIncome: -4.0, cashBalance: 109.7, payins: 21.0, payouts: 0.9, platformFees: 0.1, ads: 0.6, wallet: 0.4, ai: 0.0, affiliate: 0.0, burnMultiple:  1.07 },
  { label: 'Jul 2026', gtv: 483, revenue: 25.2, grossProfit: 9.1,  badDebt: 3.5, sm: 4.0, rd: 3.5, ga: 2.2, operatingIncome: -4.2, otherIncome:  0.0, ebitda: -4.2, netIncome: -4.2, cashBalance: 105.4, payins: 22.2, payouts: 0.9, platformFees: 0.1, ads: 1.5, wallet: 0.5, ai: 0.0, affiliate: 0.0, burnMultiple:  1.81 },
  { label: 'Aug 2026', gtv: 543, revenue: 29.1, grossProfit: 10.8, badDebt: 3.9, sm: 4.6, rd: 4.1, ga: 2.4, operatingIncome: -4.3, otherIncome:  0.0, ebitda: -4.3, netIncome: -4.3, cashBalance: 101.2, payins: 24.7, payouts: 1.0, platformFees: 0.1, ads: 2.8, wallet: 0.5, ai: 0.0, affiliate: 0.0, burnMultiple:  1.12 },
  { label: 'Sep 2026', gtv: 612, revenue: 33.7, grossProfit: 12.8, badDebt: 4.3, sm: 5.0, rd: 4.6, ga: 2.4, operatingIncome: -3.6, otherIncome:  0.0, ebitda: -3.6, netIncome: -3.6, cashBalance:  97.6, payins: 27.5, payouts: 1.1, platformFees: 0.1, ads: 4.4, wallet: 0.6, ai: 0.0, affiliate: 0.0, burnMultiple:  0.78 },
  { label: 'Oct 2026', gtv: 695, revenue: 38.7, grossProfit: 14.7, badDebt: 4.6, sm: 5.4, rd: 4.7, ga: 2.3, operatingIncome: -2.4, otherIncome:  0.0, ebitda: -2.3, netIncome: -2.4, cashBalance:  95.2, payins: 30.1, payouts: 1.3, platformFees: 0.1, ads: 6.6, wallet: 0.7, ai: 0.0, affiliate: 0.0, burnMultiple:  0.47 },
  { label: 'Nov 2026', gtv: 787, revenue: 45.4, grossProfit: 17.9, badDebt: 5.1, sm: 5.9, rd: 4.9, ga: 2.4, operatingIncome: -0.6, otherIncome:  0.0, ebitda: -0.5, netIncome: -0.6, cashBalance:  94.7, payins: 33.7, payouts: 1.4, platformFees: 0.1, ads: 9.4, wallet: 0.7, ai: 0.0, affiliate: 0.0, burnMultiple:  0.08 },
  { label: 'Dec 2026', gtv: 886, revenue: 53.0, grossProfit: 21.6, badDebt: 5.7, sm: 6.5, rd: 5.1, ga: 2.5, operatingIncome:  1.8, otherIncome:  0.0, ebitda:  1.8, netIncome:  1.8, cashBalance:  96.5, payins: 37.6, payouts: 1.5, platformFees: 0.1, ads: 12.9, wallet: 0.8, ai: 0.0, affiliate: 0.0, burnMultiple: -0.24 },
];
