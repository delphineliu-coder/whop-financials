...
export const MONTHS: PeriodData[] = [
  { label: 'Jan 2026', gtv: 248, revenue: 14.9, grossProfit: 5.9,  badDebt: 2.0, sm: 2.5, rd: 2.3, ga: 1.1, operatingIncome: -2.2, otherIncome:  0.3, ebitda: -1.9, netIncome: -1.9, payins: 14.0, payouts: 0.7, platformFees: 0.2, ads: 0.1, wallet: 0.0, ai: 0.0, affiliate: 0.0 },
  { label: 'Feb 2026', gtv: 254, revenue: 14.1, grossProfit: 5.4,  badDebt: 1.7, sm: 3.0, rd: 2.0, ga: 1.7, operatingIncome: -3.0, otherIncome:  0.0, ebitda: -3.0, netIncome: -3.0, payins: 13.2, payouts: 0.7, platformFees: 0.1, ads: 0.0, wallet: 0.0, ai: 0.0, affiliate: 0.0 },
  { label: 'Mar 2026', gtv: 308, revenue: 16.8, grossProfit: 6.0,  badDebt: 2.1, sm: 3.6, rd: 3.0, ga: 2.7, operatingIncome: -5.3, otherIncome:  0.5, ebitda: -4.8, netIncome: -4.8, payins: 15.9, payouts: 0.8, platformFees: 0.1, ads: 0.0, wallet: 0.0, ai: 0.0, affiliate: 0.0 },
  { label: 'Apr 2026', gtv: 336, revenue: 18.0, grossProfit: 6.9,  badDebt: 2.8, sm: 3.3, rd: 2.7, ga: 2.3, operatingIncome: -4.4, otherIncome:  0.3, ebitda: -4.3, netIncome: -4.1, payins: 16.9, payouts: 0.8, platformFees: 0.1, ads: 0.0, wallet: 0.0, ai: 0.0, affiliate: 0.1 },
  { label: 'May 2026', gtv: 353, revenue: 19.0, grossProfit: 7.4,  badDebt: 2.7, sm: 3.3, rd: 2.8, ga: 1.9, operatingIncome: -3.5, otherIncome:  0.0, ebitda: -3.5, netIncome: -3.5, payins: 17.9, payouts: 0.9, platformFees: 0.1, ads: 0.1, wallet: 0.1, ai: 0.0, affiliate: 0.0 },
  { label: 'Jun 2026', gtv: 461, revenue: 24.4, grossProfit: 8.3,  badDebt: 3.3, sm: 3.7, rd: 3.2, ga: 2.6, operatingIncome: -4.6, otherIncome:  0.0, ebitda: -4.5, netIncome: -4.6, payins: 20.3, payouts: 0.9, platformFees: 0.1, ads: 2.7, wallet: 0.4, ai: 0.0, affiliate: 0.0 },
  { label: 'Jul 2026', gtv: 523, revenue: 27.6, grossProfit: 9.3,  badDebt: 3.7, sm: 4.0, rd: 3.6, ga: 2.3, operatingIncome: -4.4, otherIncome:  0.0, ebitda: -4.4, netIncome: -4.4, payins: 21.6, payouts: 1.0, platformFees: 0.1, ads: 4.4, wallet: 0.5, ai: 0.0, affiliate: 0.0 },
  { label: 'Aug 2026', gtv: 591, revenue: 32.1, grossProfit: 11.2, badDebt: 4.1, sm: 4.6, rd: 4.2, ga: 2.4, operatingIncome: -4.1, otherIncome:  0.0, ebitda: -4.1, netIncome: -4.1, payins: 24.1, payouts: 1.1, platformFees: 0.1, ads: 6.3, wallet: 0.6, ai: 0.0, affiliate: 0.0 },
  { label: 'Sep 2026', gtv: 664, revenue: 37.3, grossProfit: 13.6, badDebt: 4.5, sm: 5.0, rd: 4.7, ga: 2.4, operatingIncome: -3.1, otherIncome:  0.0, ebitda: -3.1, netIncome: -3.1, payins: 26.8, payouts: 1.2, platformFees: 0.1, ads: 8.7, wallet: 0.6, ai: 0.0, affiliate: 0.0 },
  { label: 'Oct 2026', gtv: 761, revenue: 44.0, grossProfit: 16.5, badDebt: 4.8, sm: 5.5, rd: 4.8, ga: 2.3, operatingIncome: -1.0, otherIncome:  0.0, ebitda: -1.0, netIncome: -1.0, payins: 29.4, payouts: 1.3, platformFees: 0.1, ads: 12.4, wallet: 0.7, ai: 0.0, affiliate: 0.0 },
  { label: 'Nov 2026', gtv: 864, revenue: 51.9, grossProfit: 20.4, badDebt: 5.4, sm: 6.1, rd: 5.0, ga: 2.4, operatingIncome:  1.4, otherIncome:  0.0, ebitda:  1.4, netIncome:  1.4, payins: 33.1, payouts: 1.5, platformFees: 0.1, ads: 16.5, wallet: 0.8, ai: 0.0, affiliate: 0.0 },
  { label: 'Dec 2026', gtv: 976, revenue: 61.0, grossProfit: 25.1, badDebt: 6.0, sm: 6.7, rd: 5.2, ga: 2.5, operatingIncome:  4.5, otherIncome:  0.0, ebitda:  4.5, netIncome:  4.5, payins: 36.9, payouts: 1.6, platformFees: 0.2, ads: 21.4, wallet: 0.8, ai: 0.0, affiliate: 0.0 },
];
...
export const buildSankeyData = (period: PeriodData): SankeyData => {
  ...
  // Revenue source nodes — only include streams with non-zero value
  const revSources = [
