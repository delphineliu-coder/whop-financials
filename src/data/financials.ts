...
export const MONTHS: PeriodData[] = [
  ...
  { label: 'May 2026', gtv: 353, revenue: 19.1, grossProfit: 7.8,  badDebt: 2.4, sm: 4.0, rd: 2.9, ga: 2.7, operatingIncome: -4.3, otherIncome:  0.6, ebitda: -4.0, netIncome: -3.7, cashBalance: 113.7, payins: 17.9, payouts: 0.9, platformFees: 0.1, ads: 0.1, wallet: 0.1, ai: 0.0, affiliate: 0.1 },
